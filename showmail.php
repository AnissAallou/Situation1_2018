		...
		"<body style='padding: 0%; margin: 0; font-family: Helvetica, Arial , sans-serif'>".
			"<div style='background: #f7f7f7; padding: 5% 5% 5% 5%'>".
				...
				"<div style='background: white; color: #666; padding: 1%; border-radius: 0 0 10px 10px; padding-top: 20px'>".
					"<b>".
						"<span>© 2016 <a href='http://www.daewen.com' style='color:#666;outline:none;text-decoration: none;margin-bottom:5px'>Mon site de tuto</a></span>".
						
						"<span style='float: right'>".
							"<a href='https://twitter.com/Daewen_web' style='color:#666;outline:none;text-decoration: none' target='_blank'>Twitter</a> • ".
							"<a href='https://www.facebook.com/Daewen-134920490199703/' style='color:#666;outline:none;text-decoration: none' target='_blank'>Facebook</a>".
						"</span>".
					"</b>".
				"</div>".
	        "</div>".
